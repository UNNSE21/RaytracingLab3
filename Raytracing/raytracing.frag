...
void initializeDefaultLightMaterials(out SLight light)
{
	...
	materials[1].ReflectionCoef = 0.01 * smallCf;
	materials[1].RefractionCoef = 0.01 * smallRCf;
	if (SmallSphere == 1)
	...
	materials[8].ReflectionCoef = 0.01 * cubeCf;
	materials[8].RefractionCoef = 0.01 * cubeRCf;
	if (Cube == 1)
	...
	materials[9].ReflectionCoef = 0.01 * tetrCf;
	materials[9].RefractionCoef = 0.01 * tetrRCf;
	if (Tetr == 1)
